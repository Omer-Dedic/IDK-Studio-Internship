...
<body class="body">
    ...
    <!--Kartice kontakt-->
      <div class="row" id="mr0">
        <div class="col-md-3" id="wdth">
          <div class="prvakarticakontakt">
            <img class="pinkontakt1" src="slike/pin.png">
            <p class="prvip"><b>Adresa</b></p>
            <a target="_blank" href="https://www.google.com/maps/place/IDK+STUDIO+d.o.o./@44.8236214,15.8712387,17z/data=!3m1!4b1!4m6!3m5!1s0x4761405b49b439fb:0x477f0fcaa317893e!8m2!3d44.8236215!4d15.8761042!16s%2Fg%2F11dyn8929l?entry=ttu" class="drugip">PZ Kombiteks, Hamze Hume bb,</a><br>
            <a target="_blank" href="https://www.google.com/maps/place/IDK+STUDIO+d.o.o./@44.8236214,15.8712387,17z/data=!3m1!4b1!4m6!3m5!1s0x4761405b49b439fb:0x477f0fcaa317893e!8m2!3d44.8236215!4d15.8761042!16s%2Fg%2F11dyn8929l?entry=ttu" class="drugip">Bihać 77000,</a><br>
            <a target="_blank" href="https://www.google.com/maps/place/IDK+STUDIO+d.o.o./@44.8236214,15.8712387,17z/data=!3m1!4b1!4m6!3m5!1s0x4761405b49b439fb:0x477f0fcaa317893e!8m2!3d44.8236215!4d15.8761042!16s%2Fg%2F11dyn8929l?entry=ttu" class="zadnjip">Bosnia & Herzegovina</a>
          </div>
        </div>
        <div class="col-md-3" id="wdth">
          <div class="drugakarticakontakt">
            <img class="pinkontakt2" src="slike/sat.svg">
            <p class="trecip"><b>Radno vrijeme</b></p>
            <p class="cetp">Pon-Pet: <b>08:00 - 16:00</b> <br> Sub i Ned: <b>Neradni</b></p>
          </div>
        </div>
        <div class="col-md-3" id="wdth">
          <div class="trecakarticakontakt">
            <img class="pinkontakt3" src="slike/telefon.png">
            <p class="petip"><b>Broj telefona</b></p>
            <p class="sestip">Tel: <a href="tel: 387 61 123 123"><b>+387 61 123 123</b></a><br> Fax: <a href="tel: 387 61 123 123"><b>+387 61 123 123</b></a><br> Mob: <a href="tel: 387 61 123 123"><b>+387 61 123 123</b></a></p>
          </div>
        </div>
        <div class="col-md-3" id="wdth">
          <div class="cetkarticakontakt">
            <img class="pinkontakt4" src="slike/mail.png">
            <p class="sedmip"><b>Email</b></p>
            <a href="mailto: email@gmail.com" class="osmip"><b>email@gmail.com</b></a>
          </div>
        </div>
      </div>
    <!--Kraj sekcije-->
    ...
    <!--Forma za kontakt-->
      <h1 class="forma">Kontaktirajte nas</h1>
      <p class="pforma">Pošaljite nam poruku i odgovorit ćemo Vam u najkraćem mogućem roku</p>
      <div class="row" id="mr0">
        <div class="col-md-2"></div>
        <div class="col-md-8" id="wdth">
          <form class="formakontakt" action="form.php" method="post">
            <label id="imp" for="imeprezime">Ime i prezime<span class="tacka">*</span></label><br>
            <input type="text" id="imeprezime" name="iip" required>
            <div class="row" id="dvicamidantricamistan">
              <div class="col-md-6">
                <label id="mailform" for="email">Email<span class="tacka">*</span></label><br>
                <input type="email" id="email" name="email" required>
              </div>
              <div class="col-md-6">
                <label id="brojforma" for="broj">Broj mobitela</label><br>
                <input type="tel" id="broj" name="broj">
              </div>
            </div>
            <label id="porfor" for="poruka">Poruka<span class="tacka">*</span></label><br>
            <textarea id="poruka" name="poruka" rows="3" cols="115" required></textarea><br>
            <div class="asdkjb"><input class="submitformbtn" type="submit" value="Pošalji poruku"></div>
          </form>
        </div>
        <div class="col-md-2"></div>
      </div>
