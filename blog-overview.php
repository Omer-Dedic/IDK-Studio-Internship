    ...
    <!-- Page content-->
        <div class="content-dashboard">
            <div class="blog-overview">
                <h5 class="blogSecondHeader"><?= htmlspecialchars($blog['podnaslov']) ?></h5>
                <h1 class="blogHeader"><?= htmlspecialchars($blog['naslov']) ?></h1>
                <h6 class="blogSecondHeader"><?= htmlspecialchars($blog['kljucne_rijeci']) ?></h6>
                <img class="slikaBlog" src="uploads/<?= htmlspecialchars($blog['slika']) ?>">
                <p class="tekstBloga"><?= nl2br(strip_tags($blog['tekst_bloga'])) ?></p>
                <p class="datumObjave"><b>Datum objave:</b> <?= htmlspecialchars($blog['datum_objave']) ?></p>
            </div>
        </div>
    <!--End of page content-->
