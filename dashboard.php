...
$Porukesql = "SELECT COUNT(*) AS broj_novih_poruka FROM poruke WHERE procitano = 0";
$novePoruke = $conn->query($Porukesql);
$broj_novih_poruka = $novePoruke->fetch_assoc();

$recBr = "SELECT COUNT(*) AS broj_recenzija FROM recenzija";
$brRec = $conn->query($recBr);
$brojRecenzija = $brRec->fetch_assoc();

$sql = "SELECT id, Ime, Prezime, Recenzija, Ocjena, vrijeme_recenzije FROM recenzija";
...
if ($total_reviews > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $sum += intval($row['Ocjena']);
    }
    $average_rating = number_format($sum / $total_reviews, 1);
    $result->data_seek(0);
}
                    ...
                    <a href="blog-dash.php" style="text-decoration: none;">
                        <div class="box-quick-view">
                            ...
                            <div class="item-number">
                                <p class="item-number-p"><?= $ukupno_blogova?></p>
                            </div>
                        </div>
                    </a>

                    <a href="poruke-dash.php" style="text-decoration: none;">
                        <div class="box-quick-view">
                            <div class="icon-quick-view-box">
                            ...
                            <div class="item-number">
                                <p class="item-number-p"><?= $broj_novih_poruka['broj_novih_poruka']?></p>
                            </div>
                        </div>
                    </a>

                    <a href="rec-dash.php" style="text-decoration: none;">
                        <div class="box-quick-view">
                            <div class="icon-quick-view-box">
                            ...
                            <div class="item-header">
                                <p class="item-p">Recenzije</p>
                            </div>
                            <div class="item-number">
                                <p class="item-number-p"><?= $brojRecenzija['broj_recenzija']?></p>
                            </div>
                        </div>
                    </a>

                    <a href="analitika-dash.php" style="text-decoration: none;">
                        <div class="box-quick-view">
                            <div class="icon-quick-view-box">
                            ...
                            <div class="item-header">
                                <p class="item-p">Analitika</p>
                            </div>
                            <div class="item-number">
                                <p class="item-number-p"></p>
                            </div>
                        </div>
                    </a>
                ...
                <!--Last items-->
                    <div class="last-inputs">
                        ...
                        <div class="getLastMessage">
                            ...
                            <p class="read-more-latest-message">
                                <a class="read-more-latest-message" id="readMoreLink" href="#">Pročitaj više</a>
                            </p>
                            ...
                            <script>
                                fetch('zadnja_poruka.php')
                                    ...
                                    .then(data => {
                                        if (data.error) {
                                            document.getElementById('zadnjaPoruka').innerText = data.error;
                                        } else {
                                            document.getElementById('zadnjaPoruka').innerHTML = `
                                                <div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;">
                                                    ${data.poruka}<br>
                                                    Napisao: <strong>${data.ime}</strong>
                                                </div>
                                            `;
                                            document.getElementById('readMoreLink').href = `odgovori-poruka.php?id=${data.id}`;
                                        }
                                    })
                                    .catch(error => {
                                        console.error('Greška:', error);
                                        document.getElementById('zadnjaPoruka').innerText = "Greška pri učitavanju poruke.";
                                    });
                            </script>
                        </div>
                        <!--End of last message-->
                        ...
                        <div class="getLastReview">
                            ...
                            <p class="read-more-latest-message"><a class="read-more-latest-message" href="rec-dash.php">Pročitaj više</a></p>
