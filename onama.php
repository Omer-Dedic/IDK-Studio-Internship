...
<body class="body">
    ...
    <!--Prva sekcija-->
      <div class="onama1">
          <div class="row" id="mr0">
              <div class="col-md-6" id="onamagrupa1">
                  <h1 class="onamanaslov1">O NAMA</h1>
                  <p class="opisnitxtonama">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
              </div>
              <div class="col-md-6" id="slikavama">
                  <img src="slike/timonamaaa.png" class="onamaslika1 objfcov" alt="Nas tim">
              </div>
          </div>
      </div>
    <!--Kraj prve sekcije-->
    ...
    <!--Prva sekcija vol2-->
        <div class="onama1">
            <div class="row" id="mr0">
                <div class="col-md-6">
                    <img src="slike/timonama1.png" class="onamaslika2 objfcov" alt="Nas tim">
                </div>
                <div class="col-md-6" id="onamagrupa1">
                    <p class="opisnitxtonama1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                </div>
            </div>
        </div>
    <!--Kraj sekcije-->
    ...
    <!--Usluge-->
      <div class="usluge">
        <div class="row" id="mr0">
          <div class="col-md-6" id="kmoa">
            <h1 class="uslugeh1">Usluge koje nudimo:</h1>
            <p class="uslugep">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          </div>
          <div class="col-md-6">
            <div class="swiper" id="swiper1">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><div class="karticaonama">
                  <div class="ikonica"><div class="centriranje"><img class="ikonicaaaonama" src="slike/computeronama.png"></div></div>
                  <div class="usluga">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                </div></div>
                <div class="swiper-slide"><div class="karticaonama">
                  <div class="ikonica"><div class="centriranje"><img class="ikonicaaaonama" src="slike/computeronama.png"></div></div>
                  <div class="usluga">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
  ...
  <!--Tim-->
    <!--Upoznajte nas tim-->
    <div class="line1"></div>
    <h1 class="upnastim">Upoznajte naš tim</h1>
    <div class="line1"></div>
    <!--Kraj sekcije-->

    <!--Kartice-->
    <div class="row dspfjc" id="mr0">
      <div class="col" id="wdth">
        <div class="karticeonama">
          <div>
            <img class="slikaonama objfcov" src="slike/usr1.png">
          </div>
          <div class="textonama">
            <h1 class="imeonama">Lorem Ipsum</h1>
            <p class="ponama">CO-FOUNDER</p>
          </div>
        </div>
      </div>
      <div class="col" id="wdth">
        <div class="karticeonama1">
          <div>
            <img class="slikaonama1 objfcov" src="slike/usr2.png">
          </div>
          <div class="textonama1">
            <h1 class="imeonama1">Lorem Ipsum</h1>
            <p class="ponama1">CEO & CO-FOUNDER</p>
          </div>
        </div>
      </div>
      <div class="col" id="wdth">
        <div class="karticeonama2">
          <div>
            <img class="slikaonama2 objfcov" src="slike/usr3.png">
          </div>
          <div class="textonama">
            <h1 class="imeonama">Lorem Ipsum</h1>
            <p class="ponama">CO-FOUNDER</p>
